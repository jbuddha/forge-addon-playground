== forge-addon-playground
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-addon-playground addon enables blah blah...)
...
----
<dependency>
   <groupId>org.buddha.forge</groupId>
   <artifactId>forge-addon-playground</artifactId>
